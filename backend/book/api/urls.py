...
from book.api.views import AuthorListCreateAPIView,AuthorRetrieveUpdateDestroyAPIView,BookListCreateAPIView,BookRetrieveUpdateDestroyAPIView,BorrowingCreateAPIView,MemberBorrowingListAPIView
...
urlpatterns = [
    ...
    path("borrowing/member/", MemberBorrowingListAPIView.as_view(), name="member_borrowing_list"),
]